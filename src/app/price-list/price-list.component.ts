...
export interface PriceListInterface {
  ...
  const PRICELIST_DATA: PriceListInterface[] = [
    ...
    {position: 7, pickUp: 'NLNG roundabout', dropOff: 'Abalamabie junction', price: 3000, promoPrice: 2000},
    ...
    {position: 13, pickUp: 'Finima', dropOff: 'Bonny roundabout', price: 4500, promoPrice: 2500},
    {position: 14, pickUp: 'Finima', dropOff: 'Workers village junction', price: 3000, promoPrice: 1800},
    {position: 15, pickUp: 'Finima', dropOff: 'Abalamabie junction', price: 3200, promoPrice: 2000},
    ...
    {position: 29, pickUp: 'Park and ride', dropOff: 'Finima', price: 4000, promoPrice: 3000},
    {position: 30, pickUp: 'Park and ride', dropOff: 'RA gate', price: 2500, promoPrice: 2000},
    {position: 31, pickUp: 'Park and ride', dropOff: 'Wilbros junction', price: 4000, promoPrice: 2500},
    {position: 32, pickUp: 'Park and ride', dropOff: 'Shell gate', price: 4500, promoPrice: 3000},
    {position: 33, pickUp: 'Park and ride', dropOff: 'Abalamabie junction', price: 4000, promoPrice: 2800},
    {position: 34, pickUp: 'Park and ride', dropOff: 'Bonny roundabout', price: 5000, promoPrice: 3800},
    {position: 35, pickUp: 'Park and ride', dropOff: 'Bonny beach', price: 6000, promoPrice: 4000},
  ];
